...
\>[B]{}{\color{datatype}{ import }}\;\Conid{\Conid{OpenGames}.Preprocessor}{}\<[E]%
\\
\>[B]{}{\color{datatype}{ import }}\;\Conid{\Conid{OpenGames}.\Conid{Engine}.Engine}{}\<[E]%
\\[\blanklineskip]%
...
\column{4}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}{\color{datatype}{ data }}\;\Conid{Lens}\;\Varid{s}\;\Varid{t}\;\Varid{a}\;\Varid{b}\;{\color{datatype}{ where }}{}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
...
the constructor \ensuremath{{\color{datatype}{ type }}\;\Conid{Stochastic}\mathbin{::}\Conid{T}\;\Conid{Double}}, where \ensuremath{\Conid{T}} is the probability monad 
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}{\color{datatype}{ data }}\;\Conid{StochasticOptic}\;\Varid{s}\;\Varid{t}\;\Varid{a}\;\Varid{b}\;{\color{datatype}{ where }}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
...
of coend lenses where objects are pairs of sets, and morphisms are coend lenses. Composition and the tensor product is described by the \ensuremath{\Conid{Optic}} typeclass:

\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}{\color{datatype}{ class }}\;\Conid{Optic}\;\Varid{o}\;{\color{datatype}{ where }}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
...
which we can parameterize with \ensuremath{\Conid{StochasticOptic}} to get our desired category of "stochastic optics." 
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}{\color{datatype}{ type }}\;\Conid{PayoffReader}\;\Varid{a}\mathrel{=}\Conid{Reader}\;\Varid{a}\;\Conid{Double}{}\<[E]%
\\[\blanklineskip]%
...
\>[4]{}\Varid{returns}\mathbin{:};{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mid \mskip1.5mu]\;{\color{datatype}{ where }}\;\Varid{calculateCurrAttackerPayoff}\;\Varid{x}\;\Varid{y}\;\Varid{z}\mathrel{=}\Varid{runPayoff}\;\Varid{params}\;(\Varid{payoffReader1}\;\Varid{x}\;\Varid{y}\;\Varid{z}){}\<[E]%
\\
\>[B]{}\hsindent{11}{}\<[11]%
