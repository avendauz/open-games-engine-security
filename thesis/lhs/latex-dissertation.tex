...
\column{4}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{openGame}\;\Varid{exoVar}\mathrel{=}[\mskip1.5mu \Varid{opengame}\mid {}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
...
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{operation}\mathbin{:}\Varid{dependentDecision};{}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
...
We treat any parameters such as \ensuremath{\Varid{exoVar}} as exogenous parameters introduced outside the game.
