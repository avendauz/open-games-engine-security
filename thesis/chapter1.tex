...
%When composing these agents into larger games, we can tie them together either \textbf{sequentially} or in \textbf{parallel}. The terms sequential and parallel coincide with arrow composition and the tensor respectively, not necessarily the sequence of play of the game.
...
\begin{hscode}\SaveRestoreHook
	...
	\>[B]{}\Varid{twoPlayer}\;\Varid{distType}\;\Varid{actionA}\;\Varid{nameA}\;\Varid{actionD}\;\Varid{nameD}\mathrel{=}[\mskip1.5mu \Varid{opengame}\mid {}\<[E]%
	\\
	\>[B]{}\hsindent{4}{}\<[4]%
	...
	\\
	\>[B]{}\hsindent{4}{}\<[4]%
	\>[4]{}\Varid{operation}\mathbin{:}\Varid{nature}\mathbin{\$}\Varid{distType};{}\<[E]%
	\\
	\>[B]{}\hsindent{4}{}\<[4]%
	\>[4]{}\Varid{outputs}\mathbin{:}\Varid{visitorType};{}\<[E]%
	\\
	\>[B]{}\hsindent{4}{}\<[4]%
	\>[4]{}\Varid{returns}\mathbin{:};{}\<[E]%
	\\[\blanklineskip]%
	\>[B]{}\hsindent{4}{}\<[4]%
	\>[4]{}\Varid{inputs}\mathbin{:}\Varid{visitorType};{}\<[E]%
	\\
	\>[B]{}\hsindent{4}{}\<[4]%
	\>[4]{}\Varid{feedback}\mathbin{:};{}\<[E]%
	\\
	...
	\\
	\>[B]{}\hsindent{4}{}\<[4]%
	\>[4]{}\Varid{returns}\mathbin{:}\Varid{attackerPayoff};{}\<[E]%
	\\[\blanklineskip]%
	\>[B]{}\hsindent{4}{}\<[4]%
	\>[4]{}\Varid{inputs}\mathbin{:}\Varid{attackerDecision};{}\<[E]%
	\\
	\>[B]{}\hsindent{4}{}\<[4]%
	\>[4]{}\Varid{feedback}\mathbin{:};{}\<[E]%
	\\
	...
	\\
	\>[B]{}\hsindent{4}{}\<[4]%
	\>[4]{}\Varid{returns}\mathbin{:}\Varid{defenderPayoff};{}\<[E]%
	\\[\blanklineskip]%
	\>[B]{}\hsindent{4}{}\<[4]%
	\>[4]{}\mathbin{:----------------------------:}{}\<[E]%
	\\[\blanklineskip]%
	...
	\\
	\>[B]{}\hsindent{4}{}\<[4]%
	\>[4]{}\Varid{returns}\mathbin{:}\Varid{attackerPayoff},\Varid{defenderPayoff};{}\<[E]%
	\\[\blanklineskip]%
	\>[B]{}\mid \mskip1.5mu]{}\<[E]%
	\ColumnHook
...
\begin{hscode}\SaveRestoreHook
	\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
	\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
	\>[B]{}\Varid{attackerPayoff}\mathbin{::}\Conid{VisitorType}\to \Conid{VisitorMove}\to \Conid{DefenderMove}\to \Conid{Double}{}\<[E]%
	\\
	\>[B]{}\Varid{attackerPayoff}\;\Conid{Attacker}\;\Conid{Access}\;\Conid{Open}\mathrel{=}\mathrm{100}{}\<[E]%
	\ColumnHook
\end{hscode}
...
\begin{hscode}\SaveRestoreHook
	\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
	\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
	\>[B]{}\Varid{attackerStrategy}\mathbin{::}\Conid{Kleisli}\;\Conid{Stochastic}\;\Conid{VisitorType}\;\Conid{VisitorMove}{}\<[E]%
	\\
	\>[B]{}\Varid{attackerStrategy}\mathrel{=}\Conid{Kleisli}\mathbin{\$}\Varid{const}\mathbin{\$}\Varid{playDeterministically}\;\Conid{Access}{}\<[E]%
	\\[\blanklineskip]%
	\>[B]{}\Varid{defenderStrategy}\mathbin{::}\Conid{Kleisli}\;\Conid{Stochastic}\;\Conid{VisitorMove}\;\Conid{DefenderMove}{}\<[E]%
	\\
	\>[B]{}\Varid{defenderStrategy}\mathrel{=}\Conid{Kleisli}\mathbin{\$}\Varid{const}\mathbin{\$}\Varid{playDeterministically}\;\Conid{Open}{}\<[E]%
	\ColumnHook
\end{hscode}\resethooks
